...
def get_datos_analisis(fichero, masa):
    tiempo, ay, a = leer_datos(fichero)
    a_v, a_v_filtrado = calcular_aceleracion_vertical(ay, a)
    ...
    (tiempo_recortado,
     ...
     a_v_recortado, a_filtrado_recortado) = recortar_datos(tiempo, a_vertical_real, a_v, a_v_filtrado)
    ...
    (velocidad,
     ...
     potencia,
     potencia_filtrada) = calcular_cinematica(tiempo_recortado, a_v_real_recortada, a_v_real_filtrado_recortado,
                                              masa, fuerza, fuerza_filtrada)

    minimos_aceleracion = calcular_max_min(a_v_real_filtrado_recortado)[1]
    maximos_fuerza, minimos_fuerza = calcular_max_min(fuerza_filtrada)
    maximos_velocidad, minimos_velocidad = calcular_max_min(velocidad_filtrado)
    maximos_potencia, minimos_potencia = calcular_max_min(potencia_filtrada)
