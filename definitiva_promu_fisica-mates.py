...
def calcular_cinematica(tiempo_recortado, a_v_real_recortada, a_v_real_filtrado_recortado, masa, fuerza, fuerza_filtrada):
...
def hacer_graficos(tiempo_recortado, a_v_real_recortada, a_v_real_filtrado_recortado, fuerza, fuerza_filtrada, 
    ...
    plt.fill_between(tiempo_recortado[maximos_velocidad:minimos_velocidad], a_v_real_filtrado_recortado[minimos_velocidad], a_v_real_filtrado_recortado[maximos_velocidad], alpha=0.3, color='red', label='Intervalo TIA')
    plt.plot(tiempo_recortado[indice_cambio_brusco_fuerza], a_v_real_filtrado_recortado[indice_cambio_brusco_fuerza], "x", label="Inicio de impulso")
    ...
    plt.fill_between(tiempo_recortado[maximos_velocidad:minimos_velocidad], fuerza_filtrada[minimos_velocidad], fuerza_filtrada[maximos_velocidad], alpha=0.3, color='red', label='Intervalo TIA')
    plt.plot(tiempo_recortado[indice_cambio_brusco_fuerza], fuerza_filtrada[indice_cambio_brusco_fuerza], "x", label="Inicio de impulso")
    ...
    plt.fill_between(tiempo_recortado[maximos_velocidad:minimos_velocidad], velocidad_filtrado[minimos_velocidad], velocidad_filtrado[maximos_velocidad], alpha=0.3, color='red', label='Intervalo TIA')
    ...
    plt.fill_between(tiempo_recortado[maximos_velocidad:minimos_velocidad], desplazamiento_filtrado[minimos_velocidad], desplazamiento_filtrado[maximos_velocidad], alpha=0.3, color='red', label='Intervalo TIA')
    ...
    plt.fill_between(tiempo_recortado[maximos_velocidad:minimos_velocidad], potencia_filtrada[minimos_velocidad], potencia_filtrada[maximos_velocidad], alpha=0.3, color='red', label='Intervalo TIA')
    plt.plot(tiempo_recortado[indice_cambio_brusco_potencia], potencia_filtrada[indice_cambio_brusco_potencia], "x", label="Inicio de impulso")
...
def main(fichero, masa):
    ...
    tiempo_recortado, a_v_real_recortada, a_v_real_filtrado_recortado, a_v_recortado, a_filtrado_recortado = recortar_datos(tiempo, a_vertical_real, a_v, a_v_filtrado)

    # Calcular la fuerza
    fuerza, fuerza_filtrada = calcular_fuerza(a_v_recortado, masa)

    # Calcular velocidad, desplazamiento y potencia
    velocidad, velocidad_filtrado, desplazamiento, desplazamiento_filtrado, potencia, potencia_filtrada = calcular_cinematica(tiempo_recortado, a_v_real_recortada, a_v_real_filtrado_recortado, masa, fuerza, fuerza_filtrada)
